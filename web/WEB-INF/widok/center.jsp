...
<body>
    <div id="center" style="background-color:red;width:490px;float:left; margin-left:5px;margin-right:5px">
        <div style="margin-bottom:10px;margin-top:5px">
            <b><center><font size="4" face="serif">Nowości:</font></center></b>
        </div>
        <%
        ...
        <div style="margin-top:5px;margin-left:10px;">
            ...
            <div style="margin-left:10px;position:absolute;display:inline">
                ...
                <form action="" style="display:inline">
                    <input type="submit" value="Zamawiam !" style="width:90px;height:30px;background-color:lightgrey;border-color:lightgrey;"></input>
                </form>
            </div>
        </div>
